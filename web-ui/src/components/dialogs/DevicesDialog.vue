            ...
            <template #buttons>
                <v-menu location="bottom end" :close-on-content-click="false" attach="#devices-dialog">
                    <template #activator="{ props: activatorProps }">
                        <v-btn :icon="mdiCog" class="dialog-header-icon-btn" rounded="0" v-bind="activatorProps" />
                    </template>
                    <v-list>
                ...
                <v-btn :icon="mdiCloseThick" class="dialog-header-icon-btn" rounded="0" @click="closePrompt" />
            </template>
